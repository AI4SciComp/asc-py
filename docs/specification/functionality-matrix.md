...
| DOC-015 | Pages publication | `.github/workflows/docs.yml` | `tests/docs/test_sphinx_configuration.py` | `docs/development/documentation.md` | Default branch | `.github/workflows/docs.yml` deploy | Complete |
